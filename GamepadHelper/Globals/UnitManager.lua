...
---@class UnitManager
GamepadHelper_Globals_UnitManager = { }
...
---@return string
function GamepadHelper_Globals_UnitManager.GetAccountName(unitTag)
    if (unitTag == nil) then
...
---@param unitTag? UnitTag # Leave nil for current player
---@return string
function GamepadHelper_Globals_UnitManager.GetCharacterName(unitTag)
    if (unitTag == nil) then
...
---@return UnitNameInfo
function GamepadHelper_Globals_UnitManager.GetNameInfo(unitTag)
