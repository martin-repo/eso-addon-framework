...
local Name = "GameplayHelper_Globals_ItemAssessmentManager"
...
GameplayHelper_Globals_ItemAssessmentManager = { }
...
function GameplayHelper_Globals_ItemAssessmentManager.AssessItem(itemLink, filter)
