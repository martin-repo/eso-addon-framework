...
local function OnInitialActivation()
    Console.Write(String.Format(Lang.LocalizationExample["Welcome to {Tamriel:Yellow}, {1}!"], GetUnitName(UnitTag.Player)))
    Console.Write(String.Format(Lang.LocalizationExample.NiceDay))
end
