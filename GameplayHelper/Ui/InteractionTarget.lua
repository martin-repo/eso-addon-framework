...
local Name = "GameplayHelper_Ui_InteractionTarget"
...
local function CreateControlByCode()
    ...
    local root = GetControl("GameplayHelper_Ui_InteractionTarget")
    _actionLabel = CreateControl("GameplayHelper_Ui_InteractionTarget_Action", root, Type.ControlType.Label)
...
local function ShowActionInfo(name, action)
    GameplayHelper_Ui_InteractionTarget_Name:SetText(name)
